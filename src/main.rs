...
fn add_to_clipboard(data: &str) -> io::Result<String> {
    ...
    let clipboard = clipboard.map_err(|_| io::Error::new(io::ErrorKind::Other, "X11Clipboard::new()"))?;
    ...
    let atom_1 = clipboard.setter.atoms.primary;
    let s = clipboard.setter.atoms.utf8_string;
    println!("almost success=");
    clipboard.store(atom_1, s, data);
